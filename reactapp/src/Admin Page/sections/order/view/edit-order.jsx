...
import Modal2 from '../../../../Admin Page/Components/Modal2';
            ...
            <div className='container7 display'>
                ...
                {order ? ( 
                    <>
                        ...
                        <Button text={'Add Detail'} onclick={toggleModal} background={'black'} textColor={'white'} margin={0} />
                        ...
                        <div style={{ width: '100%', display: 'flex', margin: 'auto', marginBottom: '10px' }}>
                            <div style={{ width: '100%' }} className="formInputs2">
                                <div>
                                    <Select width={'25%'} margin={'0'} type={'status3'} borderRadius={"5px"} onInputChange={(e) => updateOrder('status', e.target.value)} selectedValue={order.status} disabled={order.status === "Canceled" || order.status === "Delivered" ? true : false } />
                                </div>
                            </div>
                        </div>
                        <div style={{ display: 'flex', height: 'fit-content', width: 'fit-content' }} className="formButtons">
                            ...
                            {loading ? (
                                ...
                                <Button text={'Update'} onclick={handleUpdate} background={'black'} textColor={'white'} />
                            )}
                        </div>
                        <Modal2 isVisible={isModalVisible} toggleModal={toggleModal} func={updateShipping} />
                    </>
                ) : (
                    <></>
                )}
