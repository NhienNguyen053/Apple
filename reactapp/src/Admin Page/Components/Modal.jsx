...
const Modal = ({ name, name2, name3, isVisible, toggleModal, loading, func }) => {
    return (
        <div className="modalBg" style={{ display: isVisible ? 'block' : 'none' }}>
            <div className="modal">
                <p style={{ color: 'black', fontFamily: 'SF-Pro-Display-Regular', fontSize: '20px', width: '100%' }}>Are you sure you want to delete the {name3}<span style={{ fontFamily: 'SF-Pro-Display-Bold', color: 'black' }}>{name}</span> {name2} ?</p>
