...
export default function ShopProductCard({ product, role }) {
  ...
  return (
    <Card>
      <Box sx={{ pt: '100%', position: 'relative', cursor: role === "Product Manager" ? 'pointer' : 'default'}} onClick={role === "Product Manager" ? () => handleEditClick(product.id, product) : null}>
        {'sale' && renderStatus}
