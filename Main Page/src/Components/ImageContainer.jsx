...
const ImageContainer = ({ parentMargin, parentWidth, height, icon, imageUrl, isTop, textColor, firstText, secondText, thirdText, fourthText, className, link }) => {
    return (
        <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', margin: parentMargin, width: parentWidth }} className={className}>
            <figure className='main-page-image' style={{ backgroundImage: `url(${imageUrl})`, height: height}}>
                <div style={{ textAlign: 'center', ...(isTop ? { top: '50px' } : { bottom: '50px' }), position: 'absolute', maxWidth: '400px' }}>
                    ...
                    <span style={{ color: '#bf1516', letterSpacing: '2px', display: fourthText ? 'block' : 'none', fontSize: '16px', fontFamily: 'SF-Pro-Display-Light', marginBottom: '10px' }} className='main-page-image-text-2'>SERIES 10</span>
