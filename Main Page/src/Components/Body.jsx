...
const Body = () => {
    const APP_BASE_URL = process.env.REACT_APP;
    ...
    return (
        <div style={{ marginTop: '48px' }}>
            <ImageContainer link={`${APP_BASE_URL}/iPhone-16`} height={viewportWidth > 1000 ? '624px' : '500px'} parentMargin={'0 0 15px 0'} textColor={'white'} isTop={viewportWidth > 1000 ? true : false} firstText={"iPhone 16 Pro"} secondText={"Hello, Apple Intelligence"} imageUrl={viewportWidth > 1000 ? "https://firebasestorage.googleapis.com/v0/b/apple-12071.appspot.com/o/images%2FMainPageImages%2Fhero_iphone16pro_avail__fnf0f9x70jiy_largetall.jpg?alt=media&token=b06c2fff-2ffa-4bf4-9f15-8e14b8d50c62" : "https://firebasestorage.googleapis.com/v0/b/apple-12071.appspot.com/o/images%2FMainPageImages%2Fhero_iphone16pro_avail__fnf0f9x70jiy_small.jpg?alt=media&token=55cc2d7e-a847-461a-b2da-a4b2243c5724"} />
            <ImageContainer link={`${APP_BASE_URL}/iPhone-16`} height={viewportWidth > 1000 ? '624px' : '500px'} parentMargin={'0 0 15px 0'} textColor={'white'} isTop={true} firstText={"iPhone 16"} secondText={"Hello, Apple Intelligence."} imageUrl={viewportWidth > 1000 ? "https://firebasestorage.googleapis.com/v0/b/apple-12071.appspot.com/o/images%2FMainPageImages%2Fhero_iphone16_avail__euwzls69btea_largetall.jpg?alt=media&token=4e249caa-312b-42f3-b629-bd251bbe3791" : "https://firebasestorage.googleapis.com/v0/b/apple-12071.appspot.com/o/images%2FMainPageImages%2Fhero_iphone16_avail__euwzls69btea_small.jpg?alt=media&token=2465f9bb-9db8-4fbf-a611-792f54ce3fe6"} />
            <ImageContainer link={`${APP_BASE_URL}/iPhone-15`} height={'624px'} parentMargin={'0 0 15px 0'} textColor={"white"} isTop={true} firstText={"iPhone 15 Pro"} secondText={"Titanium. So strong. So Light. So Pro"} imageUrl={viewportWidth > 1000 ? "https://firebasestorage.googleapis.com/v0/b/apple-12071.appspot.com/o/images%2FMainPageImages%2F4.1.jpg?alt=media&token=c8aa74f0-5cb9-4b95-9fc6-8c548cc18aa4" : "https://firebasestorage.googleapis.com/v0/b/apple-12071.appspot.com/o/images%2FMainPageImages%2F4.jpg?alt=media&token=6fa130e6-77f9-4975-b4d3-94a589ef745a"} />
            <div style={{ display: 'flex' }} className="imageContainer">
                <ImageContainer link={`${APP_BASE_URL}/macbook-pro`} className={"media"} height={'580px'} parentWidth={'48.5%'} parentMargin={'0 0 15px 15px'} textColor={'White'} firstText={"MacBook Pro"} secondText={"A world of smart."} imageUrl={"https://firebasestorage.googleapis.com/v0/b/apple-12071.appspot.com/o/images%2FMainPageImages%2Fpromo_macbookpro_announce__gdf98j6tj2ie_large.jpg?alt=media&token=636087c3-ef2a-4430-8eb1-8f6be1f7283f"} />
                <ImageContainer link={`${APP_BASE_URL}/iphone-15`} className={"media"} height={'580px'} parentWidth={'48.5%'} parentMargin={'0 0 15px 15px'} textColor={'black'} isTop={true} firstText={"iPhone 15"} secondText={"New camera. New design. Newphoria"} imageUrl={"https://firebasestorage.googleapis.com/v0/b/apple-12071.appspot.com/o/images%2FMainPageImages%2F4.2.jpg?alt=media&token=f6d520e3-25e3-4605-b189-19178a1bd8fb"} />
            </div>
            <div style={{ display: 'flex' }} className="imageContainer">
                <ImageContainer link={`${APP_BASE_URL}/apple-watch-series-10`} className={"media"} height={'580px'} parentWidth={'48.5%'} parentMargin={'0 0 15px 15px'} textColor={'white'} isTop={true} icon={true} firstText={" WATCH"} secondText={"Smarter. Brighter. Mightier"} fourthText={true} imageUrl={"https://firebasestorage.googleapis.com/v0/b/apple-12071.appspot.com/o/images%2FMainPageImages%2F5.1.jpg?alt=media&token=a0ec405a-ec6f-4f93-90bd-354c0454ac88"} />
                <ImageContainer link={`${APP_BASE_URL}/imac`} className={"media"} height={'580px'} parentWidth={'48.5%'} parentMargin={'0 0 15px 15px'} textColor={'black'} isTop={true} firstText={"iMac"} secondText={"Brilliant"} imageUrl={"https://firebasestorage.googleapis.com/v0/b/apple-12071.appspot.com/o/images%2FMainPageImages%2Fpromo_imac_announce__f4qdil7mfmeu_large.jpg?alt=media&token=3f6a5990-116c-4df7-af9a-6f0d4159f3eb"} />
            </div>
